package uz.lazydevelopers1.callPhone.ui.callScreen.helpers;
...
public class CallManager {
    ...
    public static Call.Callback callback = new Call.Callback(){
        ...
        public void onStateChanged(Call call, int newState) {
            ...
            Log.d("MADARA", "onStateChanged: " + newState);
            ...
            if (newState == Call.STATE_ACTIVE){
                ...
                try {
                    Log.d("MADARA", "TTT " + CallListHelper.callList.size());
                    CallListHelper.callList.remove(NUMBER_OF_CALLS - 1);
                }
                catch (Exception e){
                    e.printStackTrace();
                    Log.d("MADARA", "Disconnect error: "+e.getMessage());
                }
                ...
                Log.d("MADARA", "Call disconnect event.");
            }
