package uz.lazydevelopers1.callPhone.ui.callScreen;
...
import uz.lazydevelopers1.callPhone.ui.callScreen.helpers.ContactsHelper;
...
public class CallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("MADARA", "TOTAL_NUMBER_OF_CALLS: " + CallManager.NUMBER_OF_CALLS);
        Log.d("MADARA", "TOTAL_NUMBER_OF_CALL_OBJECT: " + CallListHelper.callList.size());
        ...
        BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context arg0, Intent intent) {
                ...
                if (action.equals("call_ended")) {
                    ...
                    Log.d("MADARA", PHONE_NUMBER + "  " + CALLER_NAME);
//                    ------------------------------------------------------------------------------
