package uz.lazydevelopers1.callPhone.ui.callScreen.services;
...
public class CallService extends InCallService {
    ...
    @SuppressLint({"SetTextI18n", "UseCompatTextViewDrawableApis", "NewApi"})
    @Override
    public void onCallAdded(Call call) {
        super.onCallAdded(call);

        Log.d("MADARA", "onCallAdded: Service");
        Log.d("MADARA", "onCallAdded: Call Details: " + call.getDetails().toString());
        ...
        Log.d("MADARA", "onCallAdded: NUM " + CallManager.NUMBER_OF_CALLS);
    ...
    public void onCallRemoved(Call call) {
        ...
        if (CallListHelper.callList.size() > 0){
            ...
            Log.d("MADARA", "onCallRemoved:........ " + call.getDetails().getDisconnectCause().toString());
        }
        else{
            Log.d("MADARA", "onCallRemoved:________ " + call.getDetails().getDisconnectCause().toString());
        }
    }
}
